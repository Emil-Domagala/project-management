      ...
      <div className="mb-3 flex w-full">
        ...
        <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary">
          <h3 className="flex items-center text-lg font-semibold dark:text-white">
            {status}
            <span
              className="ml-2 flex items-center justify-center rounded-full bg-gray-200 p-1 text-sm leading-none dark:bg-dark-tertiary"
  ...
  return (
    ...
    >
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`${process.env.NEXT_PUBLIC_AMAZON_S3_BASE_URL}/${task.attachments[0].fileURL}`}
            ...
            <div className="flex -space-x-[6px] overflow-hidden">
              {task.assignee && (
                <Image
                  ...
                  src={`${process.env.NEXT_PUBLIC_AMAZON_S3_BASE_URL}/${task.assignee.profilePictureUrl!}`}
              ...
              {task.author && (
                <Image
                  ...
                  src={`${process.env.NEXT_PUBLIC_AMAZON_S3_BASE_URL}/${task.author.profilePictureUrl!}`}
