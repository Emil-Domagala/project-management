...
const selectStyles =
  " block rounded border border-gray-300 px-3 py-2 dark:border-dark-tertiary dark:bg-dark-tertiary dark:text-white dark:focus:outline-none";
...
const HomePage = () => {
  ...
  const {
    ...
    isError: tasksError,
  } = useGetTasksQuery({ projectId: +currProject });
  ...
  return (
    <div className="container h-full w-full bg-gray-100 bg-transparent p-8">
      <Header name="Project Manager Dashboard" />
